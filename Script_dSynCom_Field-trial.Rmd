...
# Change colors
p2<- p+scale_fill_manual(values=c("lightskyblue1","mediumblue","lightgoldenrod1","darkorange","lightskyblue3","navy", "lightgoldenrod3","darkorange3","lightskyblue1","mediumblue","lightgoldenrod1","darkorange","lightskyblue3","navy", "lightgoldenrod3","darkorange3"))
p2
...
p1d <- phyloseq::plot_ordination(all.trans, ord.mds.bray, color="SampleWater",
 shape="Treatment", title="Bray-Curtis distance")+
          ...
          scale_color_manual(values=c("#cdbe70","#cb9e59","#4d5b6a","#7997a1","#686a47","peachpuff3"))+
...
p1d <- phyloseq::plot_ordination(all.trans, ord.mds.bray, color="Treatment", shape = "Tier",
  title="")+
          ...
          scale_color_manual(values=c("lightgoldenrod1","darkorange","lightskyblue1","mediumblue"))+ 
...
Acidobacteria RA
```{r}
#Subset Chryseobacterium
all.Acido <- subset_taxa(all.trans, Genus %in% c("g__Chryseobacterium"))
...
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_10", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_11", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_12", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_13", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_14", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_15", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_16", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_17", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_18", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_19", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_20", "", x) }))
...
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_4", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_5", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_6", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_7", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_8", "", x) }))
Acido.RA <- data.frame(lapply(Acido.RA, function(x) { gsub("_9", "", x) }))
